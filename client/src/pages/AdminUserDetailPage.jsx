...
export default function AdminUserDetailPage() {
  ...
  const saveRole = async (event) => { const role = event.target.value; try { const result = await adminApi.users.role(id, role); setUser({ ...user, ...payloadOf(result), role }); setNotice("Customer role updated.") } catch (requestError) { setError(errorMessage(requestError, "Customer role could not be updated.")) } }
