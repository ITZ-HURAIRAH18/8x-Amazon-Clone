...
export default function CartPage() {
  const { items, count, subtotal, updateQuantity, removeItem, loading, error } = useCart()
  const { user } = useAuth()
