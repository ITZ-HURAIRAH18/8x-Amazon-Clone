...
export default function ProductDetailPage() {
  ...
  return <div className="product-detail-page"><div className="container">
    ...
    {frequentlyBought.length > 0 && <section className="frequently-bought"><div className="section-heading"><div><span className="section-eyebrow">Complete your setup</span><h2>Frequently bought together</h2></div></div><div className="frequently-bought__grid">{frequentlyBought.map((item) => <ProductCard key={item.id} product={item} />)}</div></section>}
